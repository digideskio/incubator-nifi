...
public class KiteStorageProcessor extends AbstractKiteProcessor {
  ...
  public static DatumReader<Record> newDatumReader(Schema schema) {
    return (DatumReader<Record>) GenericData.get().createDatumReader(schema);
  }
}
